...
#constants
TOKEN = '6146700564:AAFFESLVvY077_3b952WH88pY3rG3r-_Gc8'

#Info about the Bot
#https://api.telegram.org/bot6146700564:AAFFESLVvY077_3b952WH88pY3rG3r-_Gc8/getMe
...
def predict(data):
    # API Call
    url = 'https://rossmann-model-felipec.herokuapp.com/rossmann/predict' #url heroku app
    ...
    if request.method=='POST':
        ...
        if store_id!='error':
            ...
            if data!='error':
                ...
                send_message(chat_id, 'Store Not Avaible')
                return Response('Ok', status=200)
